...
- `messaging_flow.ps1`: fluxo real cliente ↔ profissional, cursor incremental, confirmação de leitura e isolamento de acesso.
- `booking_flow.ps1`: fluxo HTTP completo de conta, disponibilidade, reservas, propostas, pagamento, execução, avaliação, notificações e administração.
...
Os testes com MySQL/Compose foram executados em 24/08/2026. A matriz transacional
